//========= Copyright Fortnite Corporation, All rights reserved. ============//
//
// Purpose: 
//
// $NoKeywords: $
...
#define Fortnite_RAND_MAX 0x7fff
...
{
	x = minVal + ((float)rand() / Fortnite_RAND_MAX) * (maxVal - minVal);
	y = minVal + ((float)rand() / Fortnite_RAND_MAX) * (maxVal - minVal);
}
